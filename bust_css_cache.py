...
for file_path in html_files:
    ...
    new_content = content.replace('"css/style.css?v=4"', '"css/style.css?v=5"')
    new_content = new_content.replace('"css/style.css?v=3"', '"css/style.css?v=5"')
    new_content = new_content.replace('"css/style.css"', '"css/style.css?v=5"')
