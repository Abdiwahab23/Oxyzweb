...
for file_path in html_files:
    ...
    new_content = content.replace('"css/style.css?v=6"', '"css/style.css?v=7"')
    new_content = new_content.replace('"css/style.css?v=5"', '"css/style.css?v=7"')
    new_content = new_content.replace('"css/style.css"', '"css/style.css?v=7"')
